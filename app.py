...
EQUIVALENCIAS_NOMBRE = {
    ...
    "MOVIL FONTIBON": "P_CAMI - FONTIBON",   # confirmar si es la misma estación
    "JAZMIN": "EL JAZMIN",
...
with tab1:
    ...
    with col1:
        ...
        if n_sin_dato > 0:
            st.caption(f"{n_sin_dato} estación(es) sin coordenadas oficiales de la RMCAB — no se pueden ubicar en el mapa.")
        st.dataframe(
