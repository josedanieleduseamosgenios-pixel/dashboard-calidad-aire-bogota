...
st.caption(
    f"Dashboard para priorización de intervención — Secretaría Distrital de Ambiente. "
    f"Serie histórica de estaciones disponible hasta **{FECHA_MAX.date()}**."
)
...
with tab2:
    ...
    fig2 = px.bar(
        ...
        labels={"pct_dias_excede": "% de días que excede el límite diario de PM10 (75 µg/m³)", "estacion": "Estación"},
        text="pct_dias_excede", height=600,
    )
    fig2.update_traces(texttemplate="%{text}%", textposition="outside")
    st.plotly_chart(fig2, use_container_width=True)
    st.caption("Estaciones con menos de ~1.000 días de registro histórico deben interpretarse con cautela.")
